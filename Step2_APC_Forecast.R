...
load(paste("/gpfs/group/dxl46/default/private/poom/apc_met/input/", type, "/", type, "_", pheno, ".RData", sep = "")) ##input to apc##
output = apc2(input)

n_pred = 20 ##Number of points to predict in the future##
...
save(m.rose, m.ie, m.rose.all, m.ie.all, file = paste("/gpfs/group/dxl46/default/private/poom/apc_met/output/", type, "/", type, "_", pheno, "_output.RData", sep = ""))
